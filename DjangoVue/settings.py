...
SECRET_KEY = "django-insecure-holh)u5!bo(17hs)b@=yhz)_xl!nda_mwh^yu)k_^chqs=@mfs"
...
# Database
# https://docs.djangoproject.com/en/4python manage.py makemigrations.2/ref/settings/#databases
